              ...
              <template slot-scope="scope">
                ...
                <label v-if="!column.hidden">
                  ...
                  <label v-if="column.type === 'operate'">
                    <label v-if="scope.row.refundStatus ==='退款中'">
                      <el-button
                    ...
                    <label v-else-if="scope.row.refundStatus ==='退款拒绝'">{{"已拒绝"}}</label>
                    <label v-else>{{"已同意"}}</label>
                  </label>
                  <!--img-->
                  <label v-else-if="column.type === 'img'">
                    <img :src="scope.row[column.key]" style="width:50px;height:50px">
                  </label>
                  <!-- 文字内容 可转码 -->
                  <span
                    v-else
